        ...
        <div class="uk-text-center uk-margin-bottom">
            <a href="<?= $this->Url->build(['controller'=>'news','action'=>'view',$new->url])?>">
                <div class="uk-inline-clip uk-transition-toggle uk-margin-bottom uk-card uk-card-default" tabindex="0">
                    <?= $this->Html->image('news/img/'.$new->image)?>
                    ...
                    <div class="uk-transition-slide-bottom uk-position-bottom uk-overlay uk-overlay-primary">
                        <p class="uk-h5 uk-margin-remove">
                            <?php $out = strlen($new->description) > 300 ? substr($new->description,0,300)."..." : $in;?>
                            <?= $out?>
                        </p>
                    </div>
                </div>
            ...
            <div>
                <a href="<?= $this->Url->build(['controller'=>'news','action'=>'view',$new->url])?>" class="uk-margin uk-link-reset uk-h4"><?= $new->title?></a>
            </div>
        </div>
        <?php endforeach?>
    </div>
